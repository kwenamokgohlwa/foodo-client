...
export default createTheme({
  ...
  tokens: {
    components: {
      ...
      authenticator: {
        ...
        modal: {
          ...
          backgroundColor: { value: "hsl(18, 100%, 95%)" },
      ...
      button: {
        ...
        _hover: {
          ...
          borderColor: { value: "{colors.brand.primary.10.value}" },
        },
        _focus: {
          color: { value: "{colors.font.focus.value}" },
          backgroundColor: { value: "{colors.brand.primary.10.value}" },
      ...
      link: {
        active: { color: { value: "{colors.brand.primary.60.value}" } },
        color: { value: "{colors.brand.primary.60.value}" },
        focus: { color: { value: "{colors.brand.primary.60.value}" } },
        hover: { color: { value: "{colors.brand.primary.10.value}" } },
    ...
    colors: {
      ...
      brand: {
        primary: {
          10: { value: "hsl(17, 96%, 82%)" },
          20: { value: "hsl(17, 95%, 78%)" },
          40: { value: "hsl(17, 95%, 70%)" },
          60: { value: "hsl(17, 95%, 63%)" },
          80: { value: "hsl(17, 57%, 50%)" },
          90: { value: "hsl(17, 55%, 38%)" },
          100: { value: "hsl(17, 55%, 32%)" },
        },
        secondary: {
          10: { value: "hsl(160, 71%, 73%)" },
          20: { value: "hsl(160, 71%, 67%)" },
          40: { value: "hsl(160, 71%, 56%)" },
          60: { value: "hsl(160, 87%, 45%)" },
          80: { value: "hsl(160, 87%, 36%)" },
          90: { value: "hsl(160, 87%, 27%)" },
          100: { value: "hsl(160, 86%, 23%)" },
        },
      },
      font: {
      ...
      background: {
        primary: { value: "hsl(210, 5%, 98%)" },
        secondary: { value: "hsla(210, 50%, 10%, 0.05)" },
